...
(g3 <- g2 +
  ...
  geom_text(data = end.df, aes(x = Year, y = Cumulative.Changes + 10, label = text.lab)) +
...
(h3 <- h2 +
  geom_text(data = y2007.df, aes(x = Year, y = Cumulative.Changes - c(5, 10, 10), label = var.lab.2)) +
  geom_text(data = end.df.2, aes(x = Year + 2, y = Cumulative.Changes, label = paste(Cumulative.Changes, "%", sep = ""))))
(h4 <- h3 +
