...
text(x = 1995, y = y1995.df[, 2:3], labels = c("시간당 임금", "생산성"), pos = 1, 3)
text(x = 2014, y = end.df[, 2:3], labels = paste(format(end.df[, 2:3], digits = 1, nsmall = 1), "%", sep = ""), pos = 3)
text(x = c(1960, 1974), y = 225, labels = legend.lab, adj = 0)
...
text(x = 2007, y = y2007.df[, 4:2] - c(5, 5, 0), labels = text.lab, pos = 1)
