...
```{r, data cars, echo = FALSE, results = 'markup'}
...
points(x = rep(prod.wage$Year[n.rows], 2), y = c(prod.wage$Net_productivity[n.rows], prod.wage$Hourly_compensation[n.rows]), pch = 21, col = c("blue", "cyan"), bg = c("blue", "cyan"), cex = 1.3)
